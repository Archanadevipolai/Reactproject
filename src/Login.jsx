...
function Login(){
    ...
    return(
        <div>
            ...
            <div className="txt" >
                <p style={{marginTop:50,fontSize:30,marginLeft:50}}>Login</p>
                ...
                <form onSubmit={handlelogin}>
                    ...
                    <p style={{marginLeft:100,marginTop:20}}>Don't have an account yet ?</p>
                    <button className="up" onClick={signup}>Sign  up  for  free</button>
